...
class HouseFilter extends Component {
    ...
    render() { 
        ...
        //When rendering lists of components from Arrays you need to specify a unique 'key' attribute
        //so react knows what component to update when a certain item in the array changes
        return (
